  ...
  */
  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype._refreshElements = function(from_node) {
      ...
      createNodeLi = function(node) {
        ...
        return $("<li class=\"" + class_string + "\"><div class=\"jqtree-element jqtree_common\"><span class=\"jqtree-title jqtree_common "+node.uniqueValue+"\">" + escaped_name + "</span></div></li>");
      };
      createFolderLi = function(node) {
        ...
        return $("<li class=\"jqtree_common " + folder_classes + "\"><div class=\"jqtree-element jqtree_common\"><a class=\"jqtree_common " + button_classes + "\">" + button_char + "</a><span class=\"jqtree_common jqtree-title "+node.uniqueValue+"\">" + escaped_name + "</span></div></li>");
      };
  ...
  DragElement = (function() {
    function DragElement(node, offset_x, offset_y, $tree) {
      ...
      this.$element = $("<span class=\"jqtree-title jqtree-dragging "+node.uniqueValue+"\">" + node.name + "</span>");
